 ...
 * @author drordas
 */
public abstract class MetaScheduler implements MetaSchedulerInterface{
    ...
    public MetaScheduler(String name, Scheduler primaryS, 
                         Scheduler secondaryS, RuleSet ruleSet)
    {
        sName = name;
        rSet = ruleSet;
        rFilter = null;
        scheduler1  = primaryS;
        scheduler2 = secondaryS;
    }
