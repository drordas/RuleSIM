 ...
 * @author drordas
 */
public class GreaterDistanceValue extends Scheduler{
    
    public GreaterDistanceValue(RuleSet ruleSet) {
        super("Greater Distance Value",ruleSet);
    }
    ...
    public Filter executeScheduler() {
        ...
        Collections.sort(rules,new Comparator<Rule>(){
            ...
            public int compare(Rule o1, Rule o2) {
                return ( Math.abs(o1.getScore() - getRequiredScore() ) < Math.abs(o2.getScore() - getRequiredScore() )?1:
                       ( Math.abs(o1.getScore() - getRequiredScore() ) > Math.abs(o2.getScore() - getRequiredScore() )?-1:0) );
            }
        });
